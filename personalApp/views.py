...
class DepartmentPersonalView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        # dinamik url yapmış olduk kullanıcı deparment adına göre istek atabilcek ve sadece ilgili deparment i sergileyebilcek
...
class PersonalListCreate(ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # sadece ilgili kullanıcı staff veya superuser ise personel create işlemi yapabilir
